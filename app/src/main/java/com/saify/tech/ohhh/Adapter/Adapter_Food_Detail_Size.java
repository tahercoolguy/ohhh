...
public class Adapter_Food_Detail_Size extends RecyclerView.Adapter<Adapter_Food_Detail_Size.ViewHolder>{
    ...
    public Adapter_Food_Detail_Size(Context context, ArrayList<Info> arrayList) {
    ...
    @NonNull
    @Override
    public Adapter_Food_Detail_Size.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_detail_size_item, parent, false);
        // set the view's size, margins, paddings and layout parameters
        Adapter_Food_Detail_Size.ViewHolder vh = new Adapter_Food_Detail_Size.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Food_Detail_Size.ViewHolder holder, int position) {
    ...
    private void setDetails(Adapter_Food_Detail_Size.ViewHolder viewHolder, int position) {
