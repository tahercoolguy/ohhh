...
public class info111 {
    ...
    public void setOrders_limit(String orders_limit) {
    ...
    public void setShop_name_en(String shop_name_en) {
        this.shop_name_en = shop_name_en;
    }
    ...
    public String getShop_name_ar() {
        return shop_name_ar;
    }

    public void setShop_name_ar(String shop_name_ar) {
        this.shop_name_ar = shop_name_ar;
    }
