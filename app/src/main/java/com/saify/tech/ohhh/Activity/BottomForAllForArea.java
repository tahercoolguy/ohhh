...
import com.saify.tech.ohhh.Adapter.Adapter_Bottom;
import com.saify.tech.ohhh.Adapter.Adapter_Bottom_Area;
import com.saify.tech.ohhh.Helper.ResponseListener;
import com.saify.tech.ohhh.Helper.Util;
import com.saify.tech.ohhh.Models.DataChangeDM;
import com.saify.tech.ohhh.R;

import java.util.ArrayList;

public class BottomForAllForArea extends BottomSheetDialogFragment implements View.OnClickListener, View.OnTouchListener

{
    ...
    private Adapter_Bottom_Area adapter;
...
//        arrayList = new DummyData(context).getDataChangeDMList();
        setData(arrayList);
    }
    ...
    public void setData(ArrayList<DataChangeDM> arrayList) {
        if (arrayList != null && arrayList.size() > 0) {
            if (adapter == null) {
                adapter = new Adapter_Bottom_Area(context, arrayList);
