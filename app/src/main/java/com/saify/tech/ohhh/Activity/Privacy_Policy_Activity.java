...
public class Privacy_Policy_Activity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector = new ConnectionDetector(Privacy_Policy_Activity.this);
        user = new User(Privacy_Policy_Activity.this);
...
//        });
    ...
    public void TermCondition () {
        if (connectionDetector.isConnectingToInternet()) {
            ...
            progress = dialogUtil.showProgressDialog(Privacy_Policy_Activity.this, getString(R.string.please_wait));
            appController.paServices.privacyPolicy(new Callback<PrivacyPolicyDM>() {
                @Override
                ...
                public void success(PrivacyPolicyDM privacyPolicyDM, Response response) {
                    ...
                    if (privacyPolicyDM.getOutput().getSuccess().equalsIgnoreCase("1"))
                        ...
                        privacyPolicy.setText(Html.fromHtml(privacyPolicyDM.getOutput().getInfo().get(0).getDescription_en(), Html.FROM_HTML_MODE_COMPACT));

                        //termAndCondition.setText(dataTerm.getItem().getDescription());

                    else
                        Helper.showToast(Privacy_Policy_Activity.this,getString(R.string.Api_data_not_found));
                }
            ...
            Helper.showToast(Privacy_Policy_Activity.this, getString(R.string.no_internet_connection));
